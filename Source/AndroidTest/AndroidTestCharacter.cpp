...
void AAndroidTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// 处理发射投射物
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AAndroidTestCharacter::StartFire);
}
...
void AAndroidTestCharacter::GetLifetimeReplicatedProps(TArray <FLifetimeProperty>& OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);

	//复制当前生命值。
	DOREPLIFETIME(AAndroidTestCharacter, CurrentHealth);
}

void AAndroidTestCharacter::OnHealthUpdate()
{
	//客户端特定的功能
...
void AAndroidTestCharacter::OnRep_CurrentHealth()
{
	OnHealthUpdate();
}

void AAndroidTestCharacter::SetCurrentHealth(float healthValue)
{
	if (GetLocalRole() == ROLE_Authority)
	{
...
float AAndroidTestCharacter::TakeDamage(float DamageTaken, struct FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
...
void AAndroidTestCharacter::StartFire()
{
	if (!bIsFiringWeapon)
	{
		bIsFiringWeapon = true;
		UWorld* World = GetWorld();
		World->GetTimerManager().SetTimer(FiringTimer, this, &AAndroidTestCharacter::StopFire, FireRate, false);
		HandleFire();
	}
}

void AAndroidTestCharacter::StopFire()
{
	bIsFiringWeapon = false;
}

void AAndroidTestCharacter::HandleFire_Implementation()
{
